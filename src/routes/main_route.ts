...
export function configureRoutes(app: Express) {
  ...
  app.post('/api/activity/update', ioCheckAuth, ActivityController.ioUpdateActivity);
  app.post('/api/activity/get', ioCheckAuth, ActivityController.ioGetActivity);
  app.post('/api/activity/user', ioCheckAuth, ActivityController.ioGetUserActivities);
